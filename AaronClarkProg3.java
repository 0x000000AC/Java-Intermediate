/*****************************************************************************
* AaronClarkProg3.java
* 
* Description: 
*	This program was created to fill partial requirements for CS219 at Park
*   University. The idea is to build a complete program that performs a simple 
...
public class AaronClarkProg3
{
	//Private Instance variables for AaronClarkProg3 Object
	...
	********************************************************************/
	...
	public AaronClarkProg3(String uSec, int vSh)
	{
	...
	********************************************************************/
	...
	public static void main(String[] args) 
	{
		...
		// Instantiate the AaronClarkProg3 class with user entered values
		AaronClarkProg3 secret = new AaronClarkProg3(userString, userShift);
		...
		// Instantiate a new AaronClarkProg3 for the new values		
		AaronClarkProg3 secret2 = new AaronClarkProg3(userDecrypt, userShift2);
		secret2.printEncrypted();
	} // end main
} // end AaronClarkProg3 class
